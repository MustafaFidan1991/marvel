...
import com.mustafafidan.marvel.databinding.ItemLoadingStateBinding

class CharactersLoadingAdapter(
    private val adapter : CharactersAdapter
) : LoadStateAdapter<CharactersLoadingAdapter.HomeStateItemViewHolder>(){
